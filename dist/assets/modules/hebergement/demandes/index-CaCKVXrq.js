import"../../../modulepreload-polyfill-Dezn_h7o.js";import{g as e,h as t,l as n,m as r,p as i,v as a,y as o}from"../../../authService-DVXfzcTf.js";import{t as s}from"../../../authGuard-CFyE0oYo.js";import{t as c}from"../../../sidebar-W_Wm9AxL.js";import{t as l}from"../../../referentielService-8I8cp3Ra.js";import{n as u,r as d,t as f}from"../../../bonsService-DzY9579a.js";s(`agent`,async({profile:s,permissions:p,affectation:m,posteId:h,anneeAcademique:g,lectureSeule:_})=>{if(console.log(`🔐 MODE LECTURE SEULE =`,_),console.log(`1 - requireRole OK`),s.service!==`Service de l'Hébergement`)return;console.log(`2 - service OK`),await c(s),console.log(`3 - sidebar chargée`),document.getElementById(`page-title`).textContent=s.affectation;let v=document.getElementById(`type`);if(v){console.log(`4 - select trouvé`);let e=await l();console.log(`5 - types récupérés`,e),v.innerHTML=``,e.forEach(e=>{v.innerHTML+=`
                        <option value="${e.id}">
                            ${e.nom}
                        </option>
            ...
            `;return}let S=await l(),C=new Map(S.map(e=>[e.id,e.nom])),w=r(a(n,`demandes_etudiants`),e(`site`,`==`,b),e(`pavillon`,`==`,x),e(`anneeAcademique`,`==`,g)),T=new Map;i(w,e=>{console.log(`📋 Demandes mises à jour :`,e.size),y.innerHTML=``;let t=0;e.forEach(e=>{let n=e.data(),r=e.id;if(T.set(r,n),n.statut&&n.statut!==`en_attente`&&n.statut!==`en_cours`)return;t++;let i=`${n.prenom||``} ${n.nom||``}`.trim(),a=``;!_&&(n.statut||`en_attente`)===`en_attente`?a=`
