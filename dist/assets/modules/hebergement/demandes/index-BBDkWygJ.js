import"../../../modulepreload-polyfill-Dezn_h7o.js";import{_ as e,b as t,g as n,m as r,u as i,v as a,y as o}from"../../../authService-BFXktNCZ.js";import{t as s}from"../../../authGuard-PwbLRTEo.js";import{t as c}from"../../../sidebar-8MgLH2MI.js";import{t as l}from"../../../referentielService-DoKQl4bb.js";s(`agent`,async({profile:s,permissions:u,affectation:d,posteId:f,anneeAcademique:p,lectureSeule:m})=>{if(console.log(`🔐 MODE LECTURE SEULE =`,m),console.log(`1 - requireRole OK`),s.service!==`Service de l'Hébergement`)return;console.log(`2 - service OK`),await c(s),console.log(`3 - sidebar chargée`),document.getElementById(`page-title`).textContent=s.affectation;let h=document.getElementById(`type`);if(h){console.log(`4 - select trouvé`);let e=await l();console.log(`5 - types récupérés`,e),h.innerHTML=``,e.forEach(e=>{h.innerHTML+=`
