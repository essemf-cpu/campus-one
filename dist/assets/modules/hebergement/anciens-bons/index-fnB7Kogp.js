import"../../../modulepreload-polyfill-Dezn_h7o.js";import{_ as e,b as t,g as n,p as r,u as i}from"../../../authService-CdYSz198.js";import{t as a}from"../../../authGuard-BeXI_65M.js";import{t as o}from"../../../sidebar-kDZzUBxa.js";import{t as s}from"../../../referentielService-DYr6ElNg.js";async function c(){return(await r(e(t(i,`bons`),n(`date`,`desc`)))).docs.map(e=>({id:e.id,...e.data()}))}a(`agent`,async({profile:e})=>{if(e.service!==`Service de l'Hébergement`)return;await o(e),document.getElementById(`page-title`).textContent=e.affectation;let t=document.getElementById(`typeFiltre`),n=await s();t.innerHTML=`<option value="">Tous les types</option>`,n.forEach(e=>{t.innerHTML+=`
