import"../../modulepreload-polyfill-Dezn_h7o.js";import{_ as e,f as t,h as n,l as r,y as i}from"../../authService-DX3gg-GL.js";import{t as a}from"../../authGuard-ykA3SEVG.js";a(`etudiant`,async({profile:a,lectureSeule:o,mode:s,anneeAcademique:c})=>{let l=document.getElementById(`codifier-content`),u=a.matricule;if(!u){l.innerHTML=`
            ...
            `;return}try{let s=await t(n(i(r,`hebergements`),e(`matricule`,`==`,u),e(`anneeAcademique`,`==`,c)));if(s.empty){l.innerHTML=`
