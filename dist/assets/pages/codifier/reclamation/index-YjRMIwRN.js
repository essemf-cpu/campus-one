import"../../../modulepreload-polyfill-Dezn_h7o.js";import{d as e,g as t,l as n,m as r,u as i,v as a}from"../../../authService-DVXfzcTf.js";import{t as o}from"../../../sessionManager-DFkkBU6L.js";import{t as s}from"../../../authGuard-CFyE0oYo.js";s(`etudiant`,async({profile:s})=>{let c=document.getElementById(`reclamation-content`),l=await o(),u=l?.anneeAcademique||sessionStorage.getItem(`anneeAcademique`);if(console.log(`📅 Année académique réclamation =`,u),console.log(`🔐 Mode session =`,l?.mode),console.log(`🔒 Lecture seule =`,l?.lectureSeule),l?.lectureSeule===!0){c.innerHTML=`
            ...
            `;return}let f=r(a(n,`hebergements`),t(`matricule`,`==`,d),t(`anneeAcademique`,`==`,u)),p;try{p=await e(f)}catch(e){console.error(`❌ Erreur récupération hébergement :`,e),c.innerHTML=`
